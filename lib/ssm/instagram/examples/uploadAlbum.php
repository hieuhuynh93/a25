...
$media = [ // Albums can contain between 2 and 10 photos/videos.
    [
        'type'     => 'photo',
        'file'     => '/var/www/html/SocialMedia/taj.jpg', // Path to the photo file.
    ],
    [
        'type'     => 'photo',
        'file'     => '/var/www/html/SocialMedia/taj1.jpg', // Path to the photo file.
    ...
    [
        'type'     => 'photo',
        'file'     => '/var/www/html/SocialMedia/taj2.jpg', // Path to the photo file.
    ],
    /*[
        'type'                => 'video',
