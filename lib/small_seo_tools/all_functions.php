...
function googleRank($searchDomain, $keyword, $position = 100, $googleDomain = 'google.com') {
...
function yahooRank($searchDomain, $keyword, $position = 100, $yahooDomain = 'yahoo.com') {
