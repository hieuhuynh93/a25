...
$arrInternalExternal = array();
$arrInternalExternal['internal_broken_link'] = $internalLinks;
$arrInternalExternal['external_broken_link'] = $externalLinks;

/* echo '<pre><br />External Broken Links ';
  print_r($externalLinks);
  echo '</pre>';

  echo '<pre><br />Internal Broken Links ';
  print_r($internalLinks);
  echo '</pre>'; */
?>
<h5>Internal Broken Links</h5>
<hr>
<table class="table table-striped table-bordered p-0">
    ...
    <tbody>
        <?php $count = 1; ?>
        <?php foreach($arrInternalExternal['internal_broken_link'] as $arrInternalLink): ?>
            <?php if($arrInternalLink[1] != 200): ?>
                <tr>
                    <td><?php echo $count; ?></td>
                    <td><a href="<?php echo $arrInternalLink[0]; ?>" target="_blank"><?php echo $arrInternalLink[0]; ?></a></td>
                    <td><?php echo $arrInternalLink[1]; ?></td>
                </tr>
                <?php $count++; ?>
            <?php endif; ?>
        <?php endforeach; ?>
...
<table class="table table-striped table-bordered p-0">
    ...
    <tbody>
        <?php $count = 1; ?>
        <?php foreach($arrInternalExternal['external_broken_link'] as $arrExternalLink): ?>
            <?php if($arrExternalLink[1] != 200): ?>
                <tr>
                    <td><?php echo $count; ?></td>
                    <td><a href="<?php echo $arrExternalLink[0]; ?>" target="_blank"><?php echo $arrExternalLink[0]; ?></a></td>
                    <td><?php echo $arrExternalLink[1]; ?></td>
                </tr>
                <?php $count++; ?>
            <?php endif; ?>
        <?php endforeach; ?>
