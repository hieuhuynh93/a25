...
$userInput = raino_trim($_POST['url']);
        ...
        foreach ($array as $url) {
            $url = clean_url($url); $url = Trim("https://$url");
...
<?php //if ($pointOut != 'output') {  ?>
            ...
            <form method="POST" action="">
                <input type="text" name="url" placeholder="Enter URL here" autofocus required class='form-control'/><br />
