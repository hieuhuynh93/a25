...
?>
        ...
        <div class="xd_top_box">
         <?php //echo $ads_720x90; ?>
           ...
           <input type="text" name='url' value="" class="form-control" placeholder='Enter URL Here' required autofocus/>
           <br />
...
<style> 
    thead th {border: 1px solid lightgray;}
    tbody td {border: 1px solid lightgray;}
</style>
