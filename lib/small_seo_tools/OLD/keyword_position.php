...
<?php //if ($pointOut != 'output') { ?>
                ...
                <form method="POST" action=""> 
                    <input type="text" name="url" id="url" value="" class="form-control" placeholder='Enter Domain URL here' autofocus required/>
                    <br />
                    <input type="text" name="keyword" value="" class="form-control" placeholder='Enter Keyword here' autofocus required/>
                    <br />
...
//} else {
    ...
    //} else {
        ...
        ?>
                    <br />
                    <style> td {border: 1px solid lightgray;} </style>
                    <table class="table table-responsive table-striped">
                        ...
                        <tbody style='box-shadow: 2px 3px 2px 2px gray;'>
                            ...
                            <tr>
                                ...
                                <td><?php echo $keyword; ?> </td>
                                <td><?php if(substr($google[1], -1) == '1') echo $google[1] . "st Position";
                                else if(substr($google[1], -1) == '2') echo $google[1] . "nd Position"; 
                                else if(substr($google[1], -1) == '3') echo $google[1] . "rd Position";
                                else if(substr($google[1], 0, 1) == 'N') echo $google[1] . "";
                                else if(substr($google[1], 0) == '') echo 'Not Found';?> </td>
                                <td><?php if(substr($yahoo[1], -1) == '1') echo $yahoo[1] . "st Position";
                                else if(substr($yahoo[1], -1) == '2') echo $yahoo[1] . "nd Position"; 
                                else if(substr($yahoo[1], -1) == '3') echo $yahoo[1] . "rd Position";
                                else if(substr($yahoo[1], 0, 1) == 'N') echo $yahoo[1] . "";
                                else if(substr($yahoo[1], 0) == '') echo 'Not Found';?> </td>
                                <td><?php if(substr($bing[1], -1) == '1') echo $bing[1] . "st Position";
                                else if(substr($bing[1], -1) == '2') echo $bing[1] . "nd Position"; 
                                else if(substr($bing[1], -1) == '3') echo $bing[1] . "rd Position";
                                else if(substr($bing[1], 0, 1) == 'N') echo $bing[1] . "";
                                else if(substr($bing[1], 0) == '') echo 'Not Found';?> </td>
                            </tr>
                        </tbody>
                    </table>
    <?php }
