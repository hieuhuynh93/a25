...
//            require_once(THEME_DIR."sidebar.php");
        ...
        <div class="col-md-10 main-index">
            ...
            <form method="POST" action="" onsubmit="return fixData();"> 
                <textarea name="data" id="data" rows="15" class="form-control" placeholder="Enter upto 10 URLs (Each URL must be on a separate line)"></textarea>
                <br />
...
//         if(isset($error)) {
            ...
            if (isset($_POST['submit'])) {
                ...
                <br />
                <h3><?php echo 'Results'; ?> <small> <?php echo 'Price of each website:'; ?></small></h3><br />
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <td><b>No.</b></td>
                            <td><?php echo '<b>URLs</b>'; ?></td>
