...
//           } else { 
            ...
            if (isset($_POST['submit'])) {
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <strong><?php echo 'URL:'; ?></strong>  <?php echo $my_url; ?> <br /> <br />
