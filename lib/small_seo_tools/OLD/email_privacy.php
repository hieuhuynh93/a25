...
<?php //if ($pointOut != 'output') {  ?>
            ...
            <form method="POST" action="">
                <input type="text" name="url" placeholder="Enter URL here" required autofocus class='form-control'><br />
...
<p><?php echo 'URL'; ?>: <strong><?php echo $my_url; ?></strong> </p>
           ...
           <img  src="<?php echo $theme_path; ?>images/okay.png" alt="success" title="Success" />
           </div>
           <?php } else { ?>
