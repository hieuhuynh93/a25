<!DOCTYPE html>
<?php include_once 'all_functions.php'; ?>
<html lang="en">
    <head>
        <meta charset="utf-8">
...
<div class="row">
        ...
        if(isset($_POST['url'])) {
            $bw = getBuiltWith(clean_url($_POST['url']));
        }
        ...
        <div class="xd_top_box">
         <?php //echo $ads_720x90; ?>
           ...
           <form method="POST" action=""> 
               <input type="text" name="url" id="url" value="" class="form-control" placeholder="Enter URL here" autofocus required/>
           <br />
