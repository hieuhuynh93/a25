...
$scan_url = 'https://www.' . clean_url(strtolower($_POST['url']));
...
<?php //if ($pointOut != 'output') {  ?>
            ...
            <form method="POST" action="">
                <input placeholder='Enter URL here' name="url" id="url" class="form-control" required autofocus><br />
