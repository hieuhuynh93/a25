...
<?php //if ($pointOut != 'output') {  ?>
            ...
            <form method="POST" action="">
                <input type="text" name="url" id="url" class="form-control" placeholder="Enter URL here" autofocus required><br />
...
<?php if(isset($_POST['submit'])){ ?>
    ...
    <textarea name="textarea" rows="30" style="width: 100%;" readonly=""><?php echo $rawData; ?></textarea>
