                ...
                <div class="row">
                   ...
                   wrapper -->
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="col-sm-6 offset-2 bg-dark">
                            <div class="card card-statistics mb-30">
                                <div class="card-body bg-dark">
                                    <h5 class="card-title text-center text-light"> Good Luck!! </h5><br />
                                    <div class="text-center">
                                        <div class="card-body text-light">
                                            <p class="text-left">The Results of this Quiz will be announced on<br /><br />
                                            Date : dd/mm/yyyy<br />
                                            Time : hh:mm:ss am/pm<br /><br />
                                            Attempts Left : 1/2</p>
                                        </div>
                                    </div>
                                </div>
