...
if (isset($_POST['url'])){
        $outData = clean_url(raino_trim($_POST['url']));
...
<div id="meta">
        <div class='row text-center'>
            <div class='table-responsive' style='box-shadow:0 2px 2px 0 gray;padding: 10px;background-color: white;'>
            <table class='table table-bordered table-striped'>
                ...
                <tr>
                    <td><?php echo ucfirst($_POST['url']); ?></td>
                    <?php if((int)$da[1] >= 60) { ?>
