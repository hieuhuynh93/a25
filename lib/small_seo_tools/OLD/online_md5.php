...
<?php //if ($pointOut != 'output') {  ?>
            ...
            <form method="POST" action="">
                <textarea name="data" placeholder="Enter Text here" required autofocus class='form-control'></textarea><br />
