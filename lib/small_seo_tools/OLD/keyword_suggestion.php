  ...
  //          require_once(THEME_DIR."sidebar.php");
        ...
        <div class="xd_top_box">
         <?php //echo $ads_720x90; ?>
           ...
           <form method="POST" action="" onsubmit="return fixKey();"> 
           <input type="text" name="key" id="key" placeholder="Enter your Keyword" class="form-control" required autofocus/>
           <br />
           ...
           */
           ...
           ?>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td style='text-align: center;'><?php $count++; echo $count; ?></td>
