...
<div id="meta" style='box-shadow:0 2px 2px 0 gray;padding: 10px;background-color: white;'>
        <div class='row text-center'>
            <table class='table' style='text-align: center;'>
                <tr>
                    <td><h1>Your Website Score is</h1></td>
                </tr>
                <tr>
            <?php if($stats['score'] >= 60) { ?>
            <td><h1 style='text-align: center;font-size: 50px;' class='text-success'><?php echo $stats['score']; ?></h1></td>
            <?php } ?>
            <?php if($stats['score'] < 60 && $stats['score'] >= 25) { ?>
            <td><h1 style='text-align: center;font-size: 50px;' class='text-warning'><?php echo $stats['score']; ?></h1></td>
            <?php } ?>
            <?php if($stats['score'] < 24) { ?>
            <td><h1 style='text-align: center;font-size: 50px;' class='text-danger'><?php echo $stats['score']; ?></h1></td>
            <?php } ?>
            </tr>
            </table>
        </div>
