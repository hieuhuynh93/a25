...
<?php //if ($pointOut != 'output') {  ?>
            ...
            <form method="POST" action="">
                <input placeholder='Enter URL Here' name="url" id="data" class="form-control" required autofocus><br />
