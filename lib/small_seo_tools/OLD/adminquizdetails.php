    ...
    <head>
        ...
        <script>
            ...
            function showMultiple() {
                ...
                xmlhttp.open("POST", "ajax/multiple.html", true);
                xmlhttp.send();
            }
            ...
            function showSingle() {
                ...
                xmlhttp.open("POST", "ajax/single.html", true);
                xmlhttp.send();
            }
        </script>
        <!-- Favicon -->
                   ...
                   wrapper -->
                    ...
                    <div class="content-wrapper">
                        <div class="page-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h4 class="mb-0"> Enter Quiz Information <br /></h4><br />
                                    <b id='countdown'></b><br />
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="adminquestions.php" method="POST">
                                    Select Quiz Category: <br /><br />
                                    <div class="control-group">
                                        <div class="controls">
                                            <label class='radio col-sm-3'><input type="radio" value="Management" name="category" checked=""> Management</label>
                                            <label class='radio col-sm-3'><input type="radio" value="IT" name="category"> Information Technology</label>
                                            <label class='radio col-sm-3'><input type="radio" value="Marketing" name="category"> Marketing</label>
                                            <br />
                                            Enter Details Below:<br /><br />
                                            <input class="form-control col-sm-4" type="text" name="organizer" required="" placeholder='Organizer'><br />
                                            <input class="form-control col-sm-4" type="text" name="name" placeholder="Quiz Name" required=""><br />
                                            <input class="form-control col-sm-4" type="text" name="time" placeholder='Quiz Time Limit (in minutes)' required=""><br />
                                            <input class="form-control col-sm-4" type="text" name="num" placeholder="No. of Questions" required="">
                                            <br /><br />
