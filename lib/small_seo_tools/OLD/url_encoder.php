...
if (isset($_POST['url'])) {
    $userInput = stripslashes($_POST['url']);
...
<?php //if ($pointOut != 'output') {  ?>
            ...
            <form method="POST" action="">
                <input placeholder='Enter URL to Encode / Decode' name="url" id="url" class="form-control" required autofocus><br />
