...
<div class="row">
    ...
    $l = simpleCurlGET($l);
    if($l != '') putMyData('tdata/'.$fL, $l);
    
    $m = simpleCurlGET($m);
    if($m != '') putMyData('tdata/'.$fM, $m);
    
    $h = simpleCurlGET($h);
    if($h != '') putMyData('tdata/'.$fH, $h);
}
...
//            require_once(THEME_DIR."sidebar.php");
        ...
        <div class="xd_top_box">
         <?php //echo $ads_720x90; ?>
           ...
           <form method="POST" action="" onsubmit="return fixData();"> 
               <textarea name="data" id="data" rows="15" class="form-control" placeholder="Enter upto 10 URLs (Each URL must be on a separate line)" required autofocus></textarea>
           <br />
