    ...
    <head>
        ...
        <script>
            ...
            function showAnswer() {
                ...
                //if()
                xmlhttp.open("POST", "ajax/quiz2.php", true);
                xmlhttp.send();
            }
                   ...
                   wrapper -->
                    ...
                    <div class="content-wrapper">
                        <div class="page-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h4 class="mb-0"> Quiz has started <br /></h4><h6> (Do not refresh the page) </h6><br />
                                    <b id='countdown'></b><br /><br />
                                </div>
                                <div class="col-sm-6">
                        ...
                        <div id="test" onclick="showAnswer()" class="card">
                            <h4 class="card-title"> seconds left... </h4>
                            <div id="show"></div><br />
                        </div><br />
