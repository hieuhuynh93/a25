...
if (isset($_REQUEST['url'])) {
    $my_url = 'http://' . clean_with_www(raino_trim($_REQUEST['url']));
...
$count = 1;
foreach ($outArr as $outVal) {
    $html .= "<tr><td>" . $count . "</td><td>" . $outVal[0] . "</td><td>" . $outVal[1] . "</td><td>" . $outVal[2] . "%</td></tr>";
    $count++;
}
echo json_encode(array('html' => $html, 'totalKeyword' => $count));
?>
