...
function similar_web_raw_data($domain, $proxy = "") {
    ...
    $response['traffic_country'] = implode(",", $traffic_country);
    $response['traffic_country_percentage'] = implode(",", $traffic_country_percentage);
    ...
    $response['top_referral_site'] = implode(",", $top_referral_site);
    $response['top_destination_site'] = implode(",", $top_destination_site);
    $response['organic_search_percentage'] = $organic_search_percentage;
    $response['paid_search_percentage'] = $paid_search_percentage;
    $response['top_organic_keyword'] = implode(",", $top_organic_keyword);
    $response['top_paid_keyword'] = implode(",", $top_paid_keyword);
    $response['social_site_name'] = implode(",", $social_site_name);
    $response['social_site_percentage'] = implode(",", $social_site_percentage);
